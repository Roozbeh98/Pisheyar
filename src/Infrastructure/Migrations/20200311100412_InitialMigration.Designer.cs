...
namespace Pisheyar.Infrastructure.Migrations
{
    ...
    [Migration("20200311100412_InitialMigration")]
            ...
            modelBuilder.Entity("Pisheyar.Domain.Entities.TblRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            RoleCreateDate = new DateTime(2020, 3, 11, 13, 34, 11, 369, DateTimeKind.Local).AddTicks(6052),
                            RoleDisplay = "کاربر عادی",
                            RoleGuid = new Guid("73056503-d578-40d7-a957-95e7ed8c84ca"),
                            RoleIsDelete = false,
                            RoleModifyDate = new DateTime(2020, 3, 11, 13, 34, 11, 369, DateTimeKind.Local).AddTicks(6603),
                            RoleName = "User"
                        },
                        new
                        {
                            RoleId = 2,
                            RoleCreateDate = new DateTime(2020, 3, 11, 13, 34, 11, 369, DateTimeKind.Local).AddTicks(7660),
                            RoleDisplay = "ادمین",
                            RoleGuid = new Guid("d158a7ba-3f5b-4ad8-9d0f-6aedab56c5aa"),
                            RoleIsDelete = false,
                            RoleModifyDate = new DateTime(2020, 3, 11, 13, 34, 11, 369, DateTimeKind.Local).AddTicks(7681),
                            RoleName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Pisheyar.Domain.Entities.TblSmsproviderConfiguration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SpcCreateDate = new DateTime(2020, 3, 11, 13, 34, 11, 361, DateTimeKind.Local).AddTicks(4579),
                            SpcGuid = new Guid("8b18f666-a796-43a6-9a96-7ba3dff18784"),
                            SpcIsDelete = false,
                            SpcModifyDate = new DateTime(2020, 3, 11, 13, 34, 11, 365, DateTimeKind.Local).AddTicks(8610),
            ...
            modelBuilder.Entity("Pisheyar.Domain.Entities.TblSmssetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SsId = 1,
                            SsCreateDate = new DateTime(2020, 3, 11, 13, 34, 11, 368, DateTimeKind.Local).AddTicks(2187),
                            SsGuid = new Guid("9bb87a38-34e9-490b-8ab9-63950bc504b7"),
                            SsIsDelete = false,
                            SsModifyDate = new DateTime(2020, 3, 11, 13, 34, 11, 368, DateTimeKind.Local).AddTicks(3204),
                            SsName = "Kavenegar",
                            SsSpcid = 1
                        });
                });
            ...
            modelBuilder.Entity("Pisheyar.Domain.Entities.TblSmstemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StId = 1,
                            StCreateDate = new DateTime(2020, 3, 11, 13, 34, 11, 368, DateTimeKind.Local).AddTicks(9039),
                            StGuid = new Guid("aca218b6-e8bd-4eb8-8ff4-9747383e9ec6"),
                            StIsDelete = false,
                            StModifyDate = new DateTime(2020, 3, 11, 13, 34, 11, 368, DateTimeKind.Local).AddTicks(9590),
            ...
            modelBuilder.Entity("Pisheyar.Domain.Entities.TblUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            UserCreateDate = new DateTime(2020, 3, 11, 13, 34, 11, 370, DateTimeKind.Local).AddTicks(8560),
                            UserEmail = "mahdiroudaki@hotmail.com",
                            UserFamily = "Roudaki",
                            UserGuid = new Guid("fd48250d-50e7-4ffa-a644-82e43980a781"),
                            UserIsActive = true,
                            UserIsDelete = false,
                            UserMobile = "09227204305",
                            UserModifyDate = new DateTime(2020, 3, 11, 13, 34, 11, 370, DateTimeKind.Local).AddTicks(9296),
                            UserName = "Mahdi",
                            UserRoleId = 1
                        });
                });
